...
export default function Home() {
  ...
  async function generatePlan() {
    ...
    if (!r.ok) {
      ...
      setMsg('Error al generar plan: ' + t);
      setLoading(false);
      return;
    }
    const data = await r.json();
  ...
  return (
    <div style={{ padding: '24px', maxWidth: 1200, margin: '0 auto' }}>
      ...
      <section style={card}>
        ...
        <textarea value={prompt} onChange={(e)=>setPrompt(e.target.value)} rows={6} placeholder="Ej: Cambiá el color del botón primario y agregá endpoint /api/health..." style={textarea}/>
        <div style={{display:'flex', gap:12, marginTop:12}}>
